...
angular.module('hoh.services', []).service('langService', function () {
  ...
  langDict.fr.motivationlabel = 'LA MOTIVATION DANS LA CR\xc9ATION HOH';
  ...
  // motivation
  langDict.en.motivation = {
    'label': 'HOH-motivation creation',
    'url': 'media/PDF English/HOH-Motivation.pdf'
  };
  langDict.fr.motivation = {
    'label': 'Cr\xe9ation HOH - motivation',
    'url': 'media/PDF English/HOH-Motivation.pdf'
  };
  // PAGES
  // page: Donate
